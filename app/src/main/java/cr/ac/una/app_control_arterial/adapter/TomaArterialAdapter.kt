package cr.ac.una.app_control_arterial.adapter
...
//import cr.ac.una.app_control_arterial.R
...
class TomaArterialAdapter(var tomasArteriales: ArrayList<TomaArterial>) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(tomaArterial: TomaArterial) {
            ...
            }else if((sistolica in 120..129) && (distolica < 80)){
                itemView.setBackgroundColor (Color.YELLOW)
            }else if((sistolica in 130..139)&& (distolica in 80..89)){
                itemView.setBackgroundColor (orangeColor)
                //naranja
            }else if((sistolica in 140..180) && (distolica in 90..120)){
